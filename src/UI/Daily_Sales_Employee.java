 ...
 * @author DELL
 */
public class Daily_Sales_Employee extends javax.swing.JFrame {

    /**
     * Creates new form Daily_Sales
     */
    public Daily_Sales_Employee() {
        initComponents();
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        dailysale daily_sale = new dailysale();
        daily_sale.dailysalesanalys(date, tbldaily);
    ...
    public class dailysale extends Daily_Sales {

        public void dailysalesanalys(JDateChooser date, JTable tbldaily) {
            super.daily(date, tbldaily, txttotaldaily);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Daily_Sales_Employee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Daily_Sales_Employee().setVisible(true);
            }
        });
    }
