...
public class Annual_Sales extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        Annual_Sales annual = new Annual_Sales();
        annual.Annual(txtyear, txttotalyear, jTable1);
   ...
   public void Annual(JTextField yearField, JTextField annualSalesField, JTable table) {
    ...
    try {
        // Clear the annual sales field before processing
        ...
        // Corrected SQL query
        String query = "SELECT product_name, SUM(quantity) AS total_quantity, price_per_unit, "
                     + "SUM(quantity * price_per_unit) AS total_sold "
                     + "FROM product WHERE YEAR(date) = ? GROUP BY product_name, price_per_unit";
        ...
        // Set the overall total sales in the text field if data is found
        if (dataFound) {
            annualSalesField.setText(String.format("%.2f", totalSalesAmount));
        } else {
            // If no records found, show an informational message and leave the total field empty
            JOptionPane.showMessageDialog(null, "No sales records found for the year " + year, "Info", JOptionPane.INFORMATION_MESSAGE);
        }
